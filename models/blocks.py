...
class Attention(nn.Module):
    def __init__(
        self, query_dim, context_dim=None, num_heads=8, dim_head=48, qkv_bias=False, fused_attn=True, attn_drop=0.0
    ):
        super().__init__()
    ...
    def __init__(
        ...
        **block_kwargs
        ...
        self.attn = attn_class(
            hidden_size, num_heads=num_heads, qkv_bias=True, fused_attn=True, **block_kwargs
        )
