...
from models.utils import sample_features5d, bilinear_sampler
from models.blocks import BasicEncoder, Mlp
from models.transformer import EfficientUpdateFormer
...
class Cotracker(nn.Module):
    def __init__(
        ...
        hidden_dim: int =  256,             # arg x
        latent_dim: int =  128,             # arg x
        patch_size: int =  14,              # arg x
        embed_dim: int =  1024,             # arg x
        former_input_dim: int = 1110,       # arg x
        model_resolution: int =  (224, 224),
        ...
        self.former_input_dim = former_input_dim
